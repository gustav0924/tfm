...
def generate_instance_1(num_vertices, required_ratio, seed_value):
    set_seed(seed_value)
    while True:
...
def generate_instance_2(num_vertices, required_ratio, seed_value):
    set_seed(seed_value)
    while True:
...
def extract_metrics(graphml_path, vertices_param, seed_value, required_ratio):
